# 🔍 RapidAPI Master Listing & Documentation Kit: Google SERP Extractor Pro

Complete documentation kit for publishing **Google SERP & Search Intelligence Extractor Pro** on **RapidAPI Studio** ([rapidapi.com/studio](https://rapidapi.com/studio)).

---

## 📌 1. RapidAPI Listing Metadata

- **API Name**: `Google SERP & Search Intelligence Extractor Pro`
- **Category**: `Search` / `SEO` / `Data`
- **Base URL**: `https://google-search-scraper-api.vercel.app` (or your MSAI gateway `https://microsaas-agent-api.vercel.app`)
...
## 📥 Sample Request JSON (POST /api/v1/search)
  ...
  "results": [
    {
      ...
      "people_also_ask": [
        {
          "question": "What is the best choice for What Are The Top 5 Crm Tools?",
...
| Plan Tier | Monthly Price | Included Searches | Overage Fee / Search |
| :--- | :--- | :--- | :--- |
| **BASIC (Free)** | `$0.00 / mo` | 50 requests | Hard Cap (No Overages) |
| **PRO** | **`$19.00 / mo`** | 2,500 requests | `$0.010 / request` |
| **ULTRA** | **`$49.00 / mo`** | 10,000 requests | `$0.006 / request` |
| **MEGA** | **`$149.00 / mo`** | 50,000 requests | `$0.004 / request` |
